...
catch (Exception $e)
{
	...
	echo "Archivo donde se produjo la excepcion : ". $e->getFile(). "<br />\n";
	echo "Linea donde se produjo la excepcion :". $e->getLine(). "<br />\n";
	echo "Pila de llamadas como si fuese una cadena :  ". $e->getTraceAsString(). "<br />\n";
	echo "Pila como array". print_r($e->getTrace()) . "<br />\n";
}
